...
public class PuntoFijoModel {
    ...
    public double errorFinal;
        ...
        public PuntoFijoModel(String valorInicial, String funcioF, String funcionG, String tolerancia, String iteraciones) {
        ...
        this.functionFEvaluator = new FunctionEvaluator(funcion);
        this.functionGEvaluator = new FunctionEvaluator(funcion);
    }
